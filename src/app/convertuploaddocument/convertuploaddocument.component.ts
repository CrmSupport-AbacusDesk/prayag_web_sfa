...
@Component({
  selector: 'app-convertuploaddocument',
  templateUrl: './convertuploaddocument.component.html',
  styleUrls: ['./convertuploaddocument.component.scss']
})
export class ConvertuploaddocumentComponent implements OnInit {
  ...
  submitdocument()
  {
        ...
        {
          this.loader = true;
          this.serve.upload_image(this.formData,"User/upload_document").subscribe((resp)=>
          {
            this.loader = false;
            console.log(resp);
            if(resp){
