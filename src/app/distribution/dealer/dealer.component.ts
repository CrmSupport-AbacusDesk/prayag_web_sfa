...
export class DealerComponent implements OnInit {
  ...
  this.sort.type="DESC"
    ...
    this.loader=true;
    this.serve.fetchData({'sort':this.sort,'user_id':this.assign_login_data2.id,'start':this.start,'pagelimit':this.page_limit,'search':this.search_val,'type':this.type,'active_tab':this.active_tab},"Distributors/distributor")
    .subscribe((result=>{
      console.log(result);
