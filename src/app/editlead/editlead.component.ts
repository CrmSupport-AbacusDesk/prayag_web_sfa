...
export class EditleadComponent implements OnInit {
  ...
  update_detail(data) {
    ...
    this.serve.fetchData({ data: leadData,'uid':this.userId,'uname':this.userName}, "Lead/leadDetailUpdate").subscribe((result => {
      console.log(result);
      this.dialog2.closeAll();
  ...
  update_lead() {
    ...
    this.serve.fetchData({ 'id': this.lead_data.id,'type':this.lead_data.change_lead,'login_id':this.userId}, "Lead/update_type").subscribe((result => {
      console.log(result);
      this.dialog2.closeAll();
      this.serve.count_list();
      this.dialog.success("Save", "Success");
